...
# 39 year mean temp to be used as baseline for calculating anomalies
...
# #Label graph
# plt.title('Annual Temperature Anomaly in South Ireland')
# plt.xlabel('Year')
...
#data.to_pickle("SouthTempanomYear+bestfit.pkl")
print(data)
